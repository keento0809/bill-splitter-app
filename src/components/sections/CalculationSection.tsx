            ...
            <div className="space-y-2">
              {result.settlements.map((settlement, index) => (
                <div
                  ...
                  className="flex flex-col md:flex-row md:items-center justify-between p-3 bg-yellow-50 border border-yellow-200 rounded-lg animate-slide-in space-y-1 md:space-y-0"
